...
class RequetesSQL extends RequetesPDO {
 ...
 /* GESTION DU JOURNAL DE BORD DE L'UTILISATEUR 
     ========================================== */

  /**
 * Récupération du journal de bord d'un utilisateur
 * @param int $utilisateur_id, clé du utilisateur
 * @return array tableau d'objets Journal
 */
public function getJournalUtilisateur($utilisateur_id) {
  $this->sql = "
      SELECT id, ip_address, date, page_vistee
      FROM journaldb
      WHERE journaldb_utilisateur_id = :utilisateur_id
      ";
